...
gulp.task('styles', function () {
  ...
  return gulp.src('src/assets/scss/style.scss')
    ...
    .pipe(gulp.dest('serve/assets/styles/'))
...
gulp.task('jslint', function () {
  gulp.src('./serve/assets/scripts/*.js')
...
gulp.task('watch', function () {
  gulp.watch(['src/**/*.md', 'src/**/*.html', 'src/**/*.xml', 'src/**/*.txt', 'src/**/*.js', 'src/assets/images/**.*'], ['jekyll-rebuild']);
  gulp.watch(['serve/assets/styles/*.css'], reload);
